...
describe('IdempotencyService', () => {
  ...
  describe('findByKey', () => {
    ...
    describe('saveResponse', () => {
      ...
      it('should update existing record to success status and save response body', async () => {
        // Arrange
        ...
        mockQueryRunner.manager.createQueryBuilder.mockReturnValue({
          setLock: jest.fn().mockReturnThis(),
          where: jest.fn().mockReturnThis(),
          getOne: jest.fn().mockResolvedValue(existingEntity),
        } as any);
      ...
      it('should use pessimistic_write lock to prevent race conditions', async () => {
        ...
        expect(
          mockQueryRunner.manager.createQueryBuilder().setLock,
